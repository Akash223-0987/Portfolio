...
const skillCategories = [
  ...
  },
  {
    ...
    icon: '🧰',
    skills: [
      { name: 'Git',              logo: `${DEV}/git/git-original.svg`,                  color: '#F05032' },
      { name: 'GitHub',           logo: `${DEV}/github/github-original.svg`,            color: '#ffffff', dark: true },
      { name: 'Postman',          logo: `${DEV}/postman/postman-original.svg`,          color: '#FF6C37' },
      { name: 'MATLAB',           logo: `${DEV}/matlab/matlab-original.svg`,            color: '#0076A8' },
      { name: 'PyCharm',          logo: `${DEV}/pycharm/pycharm-original.svg`,          color: '#21D789' },
      { name: 'Jupyter',          logo: `${DEV}/jupyter/jupyter-original.svg`,          color: '#F37626', dark: true },
    ],
  },
  {
    title: 'Data & ML',
